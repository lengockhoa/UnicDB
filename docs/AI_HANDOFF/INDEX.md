...
|----|-------|----------|------|--------|-------|----------|------|
| TASK-401 | Grid theme theo VS Code (CSS var mapping) | P0 | S | ready | - | - | `docs/AI_HANDOFF/tasks/TASK-401.md` |
| TASK-402 | Excel-like column filters + colFilterActive gating | P0 | M | ready | - | - | `docs/AI_HANDOFF/tasks/TASK-402.md` |
| TASK-403 | Version 1.3.2 + README + full-suite boundary | P1 | S | ready | - | - | `docs/AI_HANDOFF/tasks/TASK-403.md` |
