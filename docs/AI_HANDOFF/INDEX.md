...
|------|-------|--------|--------------|----------|
| TASK-001 | Message contract: thought + regenerate (host side) | done | none | unic-smart |
| TASK-002 | Webview chat UX: thinking block, copy, keybind, scroll, message states | done | TASK-001 | unic-smart |
| TASK-003 | Chat layout: pinned composer, full-height thread (CSS) | done | none | unic-smart |
| TASK-004 | Privacy regression lock: auto-context is DDL-only (HARD invariant) | done (approved_minor) | none | unic-smart |
| TASK-005 | @-mention references (DB objects + workspace files) | done | TASK-001, TASK-002 | unic-smart |
...
Cycle AA: all 5 tasks done. Shipped in v1.14.0 alongside AHL.

Cycle AHL: see INDEX_AHL.md (4/4 tasks done; 2133 tests pass; typecheck 0; compile clean).
