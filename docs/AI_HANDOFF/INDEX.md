...
| TASK-602 | Excel checkbox set-filter component (webview) | P0 | M | critical_block | unic-smart | - | `docs/AI_HANDOFF/tasks/TASK-602.md` |
| TASK-603 | Icon toolbar one row + requery-bar icons | P0 | M | approved | unic-smart | - | `docs/AI_HANDOFF/tasks/TASK-603.md` |
