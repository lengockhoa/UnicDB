...
| TASK-601 | Set-filter pure logic (entries + pass + model) | P0 | S | ready | - | - | `docs/AI_HANDOFF/tasks/TASK-601.md` |
| TASK-602 | Excel checkbox set-filter component (webview) | P0 | M | ready | - | - | `docs/AI_HANDOFF/tasks/TASK-602.md` |
