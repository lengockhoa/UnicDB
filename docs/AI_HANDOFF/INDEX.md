...
| TASK-CLEAN2-003 | Rewrite two stale comments in claudeCodeChatEngine.ts after R4.5 failTurn rework | done (PASS — awaiting batch-2 copy-back) | none | src/ai/claudeCode/claudeCodeChatEngine.ts | - |
| TASK-CLEAN2-004 | claudeCodeLiveSmoke: spawn-ENOENT fail-fast + comment drift + gate-name rename | in_progress (batch 2) | none | src/ai/claudeCode/__tests__/claudeCodeLiveSmoke.test.ts | - |
