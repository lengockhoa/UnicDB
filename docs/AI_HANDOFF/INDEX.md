...
| TASK-RP-004 | Bottom-panel regression net (integration + source/manifest scan) | approved_minor | shipped wave 3 partial @ 405af76 (unic-code, 6/6 cases pass) | src/ui/__tests__/resultsPanelBottomPanelIntegration.test.ts (new) |
