...
| TASK-002 | Full-DB DDL context injection vào buildMessages | pending_review | Exec-T2 | - |
...
| TASK-006 | Grid A (P0): no-PK ctid save bug — hidden ctid column | changes_requested | Exec-T6 | unic/unic-smart |
