...
|------|-------|--------|------|-------|----------|
| TASK-RES-001 | Webview: relocate WHERE/ORDER BY inputs into the toolbar; placeholder + Enter keydown handlers with IME-composition guard | pending_review | none | webview/main.ts, webview/styles.css, src/ui/__tests__/webviewRequery.test.ts, src/ui/__tests__/webviewToolbar.test.ts | unic-smart |
