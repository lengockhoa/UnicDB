...
|------|-------|------|---------|--------|
| TASK-001 | omp RPC client + process lifecycle (pure) | 1 | - | pending_review (fix round 1) |
...
| TASK-004 | Chat panel omp mode + install/update UX + README | 3 | 001,002,003 | pending_review |
