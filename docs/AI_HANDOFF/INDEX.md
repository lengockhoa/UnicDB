...
|----|-------|----------|------|--------|-------|----------|------|
| TASK-001 | AI config storage: SecretStorage + workspace config + reload (src/ai/config.ts) | P0 | M | changes_requested | Exec-T001-2 | unic/unic-smart | tasks/TASK-001.md |
...
| TASK-004 | AI Settings form (webview) + extension wiring + README privacy | P0 | L | changes_requested | Exec-T004-2 | unic/unic-smart | tasks/TASK-004.md |
