...
|------|-------|------|---------|--------|
| TASK-001 | omp RPC client + process lifecycle (pure) | 1 | - | approved (reviewer: unic-smart, re-review r1) |
| TASK-002 | Host-tool bridge (set_host_tools ↔ ToolRegistry) | 1 | - | approved_minor (reviewer: unic-smart) |
| TASK-003 | omp detection/version check + fallback engine switch | 2 | - | approved (reviewer: unic-smart) |
| TASK-004 | Chat panel omp mode + install/update UX + README | 3 | 001,002,003 | changes_requested (reviewer: unic-smart) |
