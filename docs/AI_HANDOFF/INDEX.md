...
|----|-------|----------|------|--------|-------|----------|------|
| TASK-001 | Pure CREATE TABLE generator (src/core/ddl/createTable.ts) | P0 | M | pending_review | - | - | tasks/TASK-001.md |
| TASK-002 | pg_catalog introspection → TableSpec (src/core/ddl/pgIntrospect.ts) | P0 | M | pending_review | - | - | tasks/TASK-002.md |
| TASK-003 | Pure ALTER diff engine (src/core/ddl/alterTable.ts) | P0 | M | pending_review | - | - | tasks/TASK-003.md |
| TASK-004 | Table designer webview + host (create + modify modes) | P0 | L | pending_review | - | - | tasks/TASK-004.md |
| TASK-005 | Extension wiring: menus, commands, utilities, refresh + reveal | P0 | L | pending_review | - | - | tasks/TASK-005.md |
| TASK-006 | PG integration tests (VSDB_IT=1) + docs (CODE_MAP, README) | P0 | M | pending_review | - | - | tasks/TASK-006.md |
