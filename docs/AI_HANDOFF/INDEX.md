...
| TASK-005 | Claude Code process/session adapter (mirror AcpProcess; stream-json + MCP config) | changes_requested | TASK-001 | src/ai/claudeCode/claudeCodeProcess.ts, src/ai/claudeCode/__tests__/claudeCodeProcess.test.ts | unic-smart |
| TASK-006 | Codex process/session adapter (mirror AcpProcess; UNVERIFIED locally — cite Codex CLI docs in task file) | changes_requested | TASK-001 | src/ai/codex/codexProcess.ts, src/ai/codex/__tests__/codexProcess.test.ts | unic-smart |
