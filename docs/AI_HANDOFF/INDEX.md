...
|------|-------|------|---------|--------|
| TASK-001 | omp RPC client + process lifecycle (pure) | 1 | - | done |
| TASK-002 | Host-tool bridge (set_host_tools ↔ ToolRegistry) | 1 | - | done |
| TASK-003 | omp detection/version check + fallback engine switch | 2 | - | done |
| TASK-004 | Chat panel omp mode + install/update UX + README | 3 | 001,002,003 | done |
