...
| TASK-002 | SQL read-only executor tool + schema→context formatter | 1 | - | pending_review (rev: unic-smart, fix round 1 by unic-code) |
| TASK-003 | AI Chat panel webview + host wiring | 2 | 001,002 | pending_review (fix round 1 by unic-code; awaiting reviewer) |
