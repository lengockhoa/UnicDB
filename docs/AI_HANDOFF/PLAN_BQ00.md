...
Goal (user, verbatim): "Ship BQ-00: provider feasibility + adapter contract spike for Google BigQuery. No real ADC. Prove `@google-cloud/bigquery` integrates with the existing UnicDB adapter boundary without modifying existing drivers."
