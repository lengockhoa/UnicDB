...
|---|---|---|---|---|---|
| 1 | TASK-ARP01-001 | Classifier matrix: formalize read-only classification by dialect (+ MySQL backtick false-positive fix) | done | none | unic-smart |
| 1 | TASK-ARP01-002 | Transaction guard: wrap `beginTransaction`/`DbTransaction.runQuery` in `guardAdapter` | done | none | unic-smart |
| 2 | TASK-ARP01-003 | Interface regression: prove no optional-API bypass (decision gate — may close as not-needed) | done | TASK-ARP01-001, TASK-ARP01-002 | unic-smart |
