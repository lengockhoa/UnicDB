...
- Branch/state: `main` — **v1.18.0 + v1.19.0 released**; v1.20.0 (DBX-05) reviewed + ready to ship.
...
## Active Work
- Handoff ACTIVE is Cycle DBX-05, done + reviewed (4/4, unic-smart APPROVED round 6 at 65b53a7 after 6 fix rounds). Shipping as v1.20.0, then AIX-02 is next.
- v1.19.0 is the latest published release until v1.20.0 is pushed.
...
## Next Candidates
1. Next portfolio cycle: AIX-02 Safe File Operations (wave 3), then AIX-03, DBX-06, AIX-04, AIX-05, DBX-07, AIX-06, AIX-07, DBX-08, AIX-08 per PRODUCT_ROADMAP.
